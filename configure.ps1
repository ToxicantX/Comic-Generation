param(
    ...
    [string]$ComfyCheckpoint = "",
    [string]$ComfyLoraName = "",
    [double]$ComfyLoraStrengthModel = 1.0,
    [double]$ComfyLoraStrengthClip = 1.0,
    [string]$ComfyControlnetName = "",
    [double]$ComfyControlnetStrength = 1.0,
    [double]$ComfyControlnetStart = 0.0,
    [double]$ComfyControlnetEnd = 1.0,
    [int]$ComfySteps = 28,
    [double]$ComfyCfg = 7.0,
    [string]$ComfySampler = "dpmpp_2m",
    [string]$ComfyScheduler = "karras",
    [int]$DefaultPages = 8,
...
@(
    ...
    "COMIC_PIPELINE_COMFY_CHECKPOINT=$ComfyCheckpoint",
    "COMIC_PIPELINE_COMFY_LORA_NAME=$ComfyLoraName",
    "COMIC_PIPELINE_COMFY_LORA_STRENGTH_MODEL=$ComfyLoraStrengthModel",
    "COMIC_PIPELINE_COMFY_LORA_STRENGTH_CLIP=$ComfyLoraStrengthClip",
    "COMIC_PIPELINE_COMFY_CONTROLNET_NAME=$ComfyControlnetName",
    "COMIC_PIPELINE_COMFY_CONTROLNET_STRENGTH=$ComfyControlnetStrength",
    "COMIC_PIPELINE_COMFY_CONTROLNET_START=$ComfyControlnetStart",
    "COMIC_PIPELINE_COMFY_CONTROLNET_END=$ComfyControlnetEnd",
    "COMIC_PIPELINE_COMFY_STEPS=$ComfySteps",
    "COMIC_PIPELINE_COMFY_CFG=$ComfyCfg",
    "COMIC_PIPELINE_COMFY_SAMPLER=$ComfySampler",
    "COMIC_PIPELINE_COMFY_SCHEDULER=$ComfyScheduler",
